...
export class SchemaSync1708775558842 implements MigrationInterface {
    name = 'SchemaSync1708775558842'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "coffee" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "brand" character varying NOT NULL, "recommendations" character varying NOT NULL DEFAULT '0', CONSTRAINT "PK_4d27239ee0b99a491ad806aec46" PRIMARY KEY ("id"))`);
